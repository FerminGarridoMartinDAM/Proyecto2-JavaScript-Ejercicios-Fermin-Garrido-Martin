...
const users = [
  ...
  { name: "Khamala", years: 16 },
    ...
    function separateAdults (array) {
        for ( element of array ) {
            if (element.years >= 18 ) {
                console.log("Usuarios mayores de edad: " , element)
            }else{  (element.years > 18)
                console.log("Usuarios menores de edad: " , element)
            }
        }
    }
    separateAdults ( users)